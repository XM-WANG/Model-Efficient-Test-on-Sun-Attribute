...
from classifier.models import ResNet, VGGNet, DenseNet
from classifier.evaluator import Evaluator


def get_data(dataset_name, data_dir, crop_w, crop_h, batch_size, workers):
...
def main(args):
    ...
    print("=> get epoch {}  best top5 recall {:.1%}".format(
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-d', '--dataset', type=str, default='sun', choices=['sun'])
    ...
    # model
    parser.add_argument(
        '--depth', type=int, default=121, choices=[121, 169, 201, 161])
    ...
    parser.add_argument(
        ...
        type=str,
        metavar='PATH',
        default=osp.join(working_dir, 'logs/dense/1'))
