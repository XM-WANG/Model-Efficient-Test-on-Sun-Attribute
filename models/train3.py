...
from classifier.models import ResNet, VGGNet, InceptionNet
...
def main(args):
    ...
    if args.optimizer == 'sgd':
        ...
        base_param_ids = set(map(id, model.parameters()))
        new_params = [
...
if __name__ == '__main__':
    ...
    # model
    parser.add_argument('--depth', type=int, default=16, choices=[16, 19])
